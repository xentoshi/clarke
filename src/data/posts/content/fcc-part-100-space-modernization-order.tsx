...
export default function Post() {
  return (
    <div className="prose-clarke">
      ...
      <p>
        Part 100 turns ephemeris-sharing with an FCC-approved space situational awareness (SSA) provider
        from a voluntary best practice under Part 25 into a binding condition of licensing. This is the
        first time the FCC has legally compelled competing operators into a common tracking framework.
      </p>
      <p>
        ...
        is obvious: the ecosystem built around Commerce&apos;s TraCSS pathfinder program, companies like
        LeoLabs, Slingshot Aerospace, COMSPOC, Kayhan Space, and SpaceNav. None of them has been named.
      </p>
      ...
      <p>
        ...
        multiple outlets covering the order report is excluded from the new framework&apos;s revised
        processing timelines. Blue Origin filed its own orbital-compute application in March (Project
        Sunrise, up to 51,600 satellites), and a startup called Orbital Compute filed a 100,000-satellite
        version in June, so this now reads as a pattern across the emerging orbital-compute sub-industry
        rather than a SpaceX-specific problem.
      </p>
      <p>
        ...
        <strong> Processing Round</strong>, Spectral Constraints, and Federal Coordination. Any of these
        pull an application out of the default &quot;presumed acceptable&quot; treatment and into the
        slower, case-by-case track. Unprecedented-scale, multi-band NGSO systems like these are the
        textbook case for landing in Processing Round or Spectral Constraints review, and that&apos;s the
        mechanism multiple outlets covering the order point to for why the megaconstellation filings are
        excluded, though the order&apos;s text doesn&apos;t spell out the specific clause. Whatever the
        precise mechanism, the agency built an assembly line and left its largest-ever filings at the
        manual workstation, with no committed timeline. Whatever you think of a million-satellite compute
        cloud, the case that most argues for reform is the case reform doesn&apos;t reach.
      </p>
      ...
      <p>
        ...
        and the House Science Committee&apos;s bipartisan leadership, chairman Brian Babin (R-Texas) and
        ranking member Zoe Lofgren (D-Calif.), told the FCC in writing twice, first in February and again
        on July 21, the day before the vote, that Congress never granted it that authority. Their February
        letter put it directly: &quot;The Communications Act of 1934 — enacted decades before the advent of
        spaceflight — contains no clear congressional authorization empowering the FCC to regulate space
        safety, space traffic management, or broader noncommunications space operations.&quot; The
        Commission didn&apos;t change course and voted 3-0 anyway.
      </p>
      <p>
      ...
      <p>
        ...
        two. A registry that records who holds a position without also recording which regime licensed it
        will misprice that risk. That&apos;s a data-model question Clarke now has to answer, and a subject
        for a follow-up post once the litigation picture clarifies.
      </p>
      <p>
        ...
        signals: the exact conditions under which a structured registry becomes more useful than a stack of
        PDFs. That&apos;s not a coincidence we&apos;re complaining about.
      </p>
