...
export const DOC_PAGES: DocMeta[] = [
  {
    ...
    tldr: "Occupancy clusters on Space-Track TLE longitude when quality gates pass, otherwise the UCS catalog. FCC rows come from the committed SSAL workbook. Implied value is a labeled v0 model. Simulated books, ITU stubs, and seeded history sit behind Experimental — not the default Terminal.",
  },
  {
    slug: "valuation",
    href: "/docs/valuation",
