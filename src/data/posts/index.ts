...
export const posts: Post[] = [
  ...
  },
  {
    ...
    date: "2026-05-25",
    readingMinutes: 9,
    excerpt: "A Mars habitat must hold 101 kPa against roughly 0.6 kPa outside, limit radiation toward a 50 mSv/yr threshold in an environment averaging about 244 mSv/yr at the surface, survive daily temperature swings on the order of 70°C, and keep a small group psychologically functional for years with no exit. This is not harsh-climate architecture. The constraints are different in kind.",
    tag: "Engineering",
  },
  {
    ...
    date: "2026-05-22",
    readingMinutes: 18,
    excerpt: "Earth is one planet orbiting one star. Every extinction risk has a single point of failure. A species on two planets has a backup. Getting there is fourteen problems stacked in sequence, each requiring the previous to be substantially solved. This is the chain, from launch to governance.",
    tag: "Deep Analysis",
  },
  {
