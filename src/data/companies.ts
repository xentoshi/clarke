...
export const companies: Company[] = [
  // GEO Operators
  { slug: "ses", name: "SES", sector: "GEO Operators", hq: "Betzdorf, Luxembourg", founded: 1985, description: "World's largest commercial satellite operator by revenue. Operates 70+ satellites across GEO and MEO. Manages the Astra fleet serving Europe, including the 19.2°E position, the most heavily loaded orbital arc in the world. Revenue ~€2B/year from transponder leases to broadcasters, governments, and enterprise clients." },
  { slug: "intelsat", name: "Intelsat", sector: "GEO Operators", hq: "McLean, VA", founded: 1964, description: "Founded as an intergovernmental satellite organization, now a private operator with 50+ GEO satellites covering every region on Earth. Emerged from Chapter 11 bankruptcy in 2022 after C-band spectrum clearing costs and declining broadcast TV revenue. Primary markets: government, military, aviation, and enterprise." },
  { slug: "eutelsat", name: "Eutelsat", sector: "GEO Operators", hq: "Paris, France", founded: 1977, description: "European GEO operator with 35+ satellites. Merged with OneWeb in 2023, combining GEO broadcast infrastructure with LEO broadband. The Hot Bird position at 13°E serves 500+ TV channels to 100M+ European homes. Facing revenue decline as linear TV shrinks." },
  { slug: "telesat", name: "Telesat", sector: "GEO Operators", hq: "Ottawa, Canada", founded: 1969, description: "Canadian GEO operator holding some of North America's most valuable orbital positions, including 107.3°W (Anik F2). Developing Telesat Lightspeed, a 198-satellite LEO broadband constellation. Primary customers: Canadian government, broadcasters, and enterprise across the Americas." },
  { slug: "arabsat", name: "Arabsat", sector: "GEO Operators", hq: "Riyadh, Saudi Arabia", founded: 1976, description: "Arab League-owned satellite operator serving 22 member states. Operates the Badr satellite fleet at 26°E, the dominant direct-to-home position for the Arab world, broadcasting 500+ channels to 100M+ homes. Also provides government and enterprise connectivity across the Middle East and North Africa." },
  { slug: "rscc", name: "RSCC", sector: "GEO Operators", hq: "Moscow, Russia", founded: 1967, description: "Russian Satellite Communications Company, a state-owned operator managing Russia's civilian satellite fleet including the Express series. Covers Russia's vast interior (Siberia, the Far East, and the Arctic) with C-band and Ku-band capacity. Government and federal broadcasting mandates are the primary revenue source." },
  { slug: "hispasat", name: "Hispasat", sector: "GEO Operators", hq: "Madrid, Spain", founded: 1992, description: "Spanish satellite operator connecting Europe and Latin America. Holds strategic positions at 30°W and 36°W covering the Iberian Peninsula, Brazil, and Spanish-speaking markets across the Americas. 50% owned by Red Eléctrica de España (the Spanish grid operator) and considered national infrastructure." },
  { slug: "measat", name: "Measat", sector: "GEO Operators", hq: "Kuala Lumpur, Malaysia", founded: 1996, description: "Malaysian satellite operator serving Southeast Asia, South Asia, and the Middle East from 91.5°E. Provides broadcast and broadband services across some of the world's densest population corridors. Owned by Usaha Tegas, the private holding company of Malaysian billionaire T. Ananda Krishnan." },
