...
export function createServer(): McpServer {
  ...
  server.tool(
    "clarke_get_terminal",
    "Slot Terminal model for one GEO position: TLE-primary occupancy (UCS/TLE longs, Δ, disputed flag), rights-chain stub, valuation v0 with drivers, 30-day model history (backfill unless seeded), simulated capacity book (labeled, not live trades), and nearest comps.",
